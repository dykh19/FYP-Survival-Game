...
public class GunInventory : MonoBehaviour
{
	...
	*/
    ...
    /*
	 * Grabbing the icons from the Resources/Weapo_Icons/ -> gun name of the image.
	 * (!!!!!!!1!READ IMPORTANT) 
    ...
    IEnumerator UpdateIconsFromResources()
    {
        ...
        {
            icons[i] = (Texture)Resources.Load("Player_Resources/Weap_Icons/" + gunsIHave[i].ToString() + "_img");
        }
    ...
    IEnumerator Spawn(int _redniBroj)
    {
        ...
        if (currentGun)
        {
            if (currentGun.name.Contains("Gun"))
            {
                ...
                GameObject resource = (GameObject)Resources.Load("Player_Resources/" + gunsIHave[_redniBroj].ToString());
	...
	*/
	 ...
	 * From here I am listing through guns I have and drawing corresponding images on the sceen.
	 */
    void OnGUI()
    {
