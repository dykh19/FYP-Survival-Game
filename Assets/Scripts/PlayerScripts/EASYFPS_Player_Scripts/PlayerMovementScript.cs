...
public class PlayerMovementScript : MonoBehaviour {
	...
	*/
	...
	/*
	* Handles jumping and adds the force and sounds.
	*/
	void Jumping(){
	...
	*/
	...
	public bool been_to_melee_anim = false;
	private void RaycastForMeleeAttacks(){
		...
		if (GetComponent<GunInventory> ().currentGun) {
			if (GetComponent<GunInventory> ().currentGun.GetComponent<GunScript> ().meleeAttack == false) {
				been_to_melee_anim = false;
			}
			if (GetComponent<GunInventory> ().currentGun.GetComponent<GunScript> ().meleeAttack == true && been_to_melee_anim == false) {
				been_to_melee_anim = true;
				//	if (isRunning == false) {
				StartCoroutine ("MeleeAttackWeaponHit");
				//	}
			}
		}
	 ...
	 */
	IEnumerator MeleeAttackWeaponHit(){
