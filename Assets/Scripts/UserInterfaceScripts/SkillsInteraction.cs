...
public class SkillsInteraction : MonoBehaviour
{
    ...
    public void DisplaySkill(PlayerSkill skillRef)
    {
        ...
        description.text = skillRef.skill.Description + ItemsToString(skillRef.skill.requirements);
        ...
        if (button.IsActive())
        {
            ...
            if (skillNotMax && prereqUnlocked && playerHasItems)
            {
                ...
                button.onClick.AddListener(() =>
                {
                    ...
                    RemoveItems(skillRef.skill.requirements);
    ...
    private static string ItemsToString(ItemRequirement[] items)
    {
    ...
    private static void RemoveItems(ItemRequirement[] items)
    {
        foreach (var target in items)
        {
